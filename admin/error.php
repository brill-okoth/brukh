    ...
    <div class="container">
         ...
         <div class="row text-center">
                ...
                <div class="col-md-12 set-pad" >
                           ...
                           <p class="p-err">We are sorry about this. Please bare with us. Thanks.</p>
                    <a href="dashboard-index.html"class="btn btn-danger" ><i class="fa fa-mail-reply"></i>&nbsp;PLEASE GO BACK</a>
                        </div>
    ...
    <div class="container">
        <div class="row text-center">
            <div class="col-md-12">
                ...
                All Rights Reserved | &copy www.stringofgita.com
            </div>
